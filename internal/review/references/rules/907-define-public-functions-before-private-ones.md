...
A violation is a private function defined before a public one, `main` not appearing first within the public group, or either group otherwise left out of alphabetical order within itself (`main` excepted — it always leads the public group regardless of alphabetical position).
